...
in
{
  ...
  buildFromNixStore = pkgs.writeShellScriptBin "build-from-store" ''
    ...
    purs compile ${builtins.toString (builtins.map getStoreGlob (builtins.attrValues inputs))} "$@"
    echo done.
  '';
    ...
    pkgs.stdenv.mkDerivation {
      ...
      installPhase = ''
        ...
        purs compile "$src/**/*.purs" ${
          builtins.toString (builtins.map (x: ''"${x.outPath}/src/**/*.purs"'') (builtins.attrValues inputs))
        }
        mv output $out
      '';
    };
